      ...
      <main className='bg-white px-10 md:px-20 lg:px-40'>
          <section className='min-h-screen'>
            <nav className='py-10 mb-12 flex justify-between'>
              <h1 className='text-xl font-burtons'>Developed By Joan</h1>
            ...
            <div className="text-center p-10">
              ...
              <p className='text-ms py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto'>
          ...
          <section>
            ...
            <div className='lg:flex gap-10'>
              <div className='grid place-items-center shadow-lg p-10 rounded-xl my-10'>
